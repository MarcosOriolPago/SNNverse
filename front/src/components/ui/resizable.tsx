...
const ResizablePanel = React.forwardRef<PanelImperativeHandle, React.ComponentProps<typeof Panel>>(
  ({ className, ...props }, ref) => (
    <Panel
      panelRef={ref} // Connects the imperative handle (expand/collapse)
